...
public class SeckillSessionController {
    ...
    @GetMapping("/latestThreeDaysSeckillSession")
    public R getLatestThreeDaysSeckillSession() {
        List<SeckillSessionEntity> sessions = seckillSessionService.getLatestThreeDaysSeckillSession();
